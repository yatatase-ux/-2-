...
PREP_CONSTRUCTOR(PrepHomeStage),
	partyButton(WINDOW_W / 4,	   WINDOW_H / 2, 130.0f, 2.0f, "data/button/Party.png", "パーティ", GetColor(0, 0, 0), GetColor(128, 0, 0)),
	memberButton(WINDOW_W / 4 * 3, WINDOW_H / 2, 130.0f, 2.0f, "data/button/BattleStart.png", "戦闘", GetColor(0, 0, 0), GetColor(128, 128, 0))
{
